...
namespace HRM_BE.Core.Models.Profile.ContactInfo
{
    public class UpdateContactInfoRequest
    {
        ...
        public string? EmailEmergency { get; set; } // địa chỉ email khẩn cấp
        ...
        public int? CityProvideId { get; set; }
        ...
        public string? HeathcareRegistractionLocation { get; set; } // NƠI ĐĂNG KÝ KHÁM CHỮA 
