...
{
    public class DetailTimeSheetDto
    {
        ...
        public virtual List<GetDetailTimeSheetStaffPositionDto> DetailTimesheetNameStaffPositions { get; set; }// Vị trí áp dụng chấm công, ví dụ: "Tất cả vị trí".
