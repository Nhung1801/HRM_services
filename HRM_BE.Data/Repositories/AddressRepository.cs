...
namespace HRM_BE.Data.Repositories
{
    ...
    {
        public AddressRepository(HrmContext dbContext, IHttpContextAccessor httpContext) : base(dbContext, httpContext)
        {
        }
        ...
        {
            var query = await _dbContext.Countries.ToListAsync();
            return query;
