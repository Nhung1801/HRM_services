...
namespace HRM_BE.Api.Providers
{
    public static class IdentityProvider
    {
        public static IServiceCollection AddIdentityProvider(this IServiceCollection services, WebApplicationBuilder builder)
        {
            ...
            }).AddEntityFrameworkStores<HrmContext>().AddDefaultTokenProviders();
            ...
            }).AddJwtBearer(x =>
            {
                ...
                x.Events = new JwtBearerEvents
                {
                    OnMessageReceived = context =>
                    {
                        ...
                        if (!string.IsNullOrEmpty(accessToken) && path.StartsWithSegments("/hubs/remind-work-notification-hub"))
                        {
